  ...
  return (
    <section ref={sectionRef} className="relative py-20 px-4 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        {/* Map visualization */}
        <div className="relative h-64 sm:h-80 mb-10">
          {/* Connection line */}
          ...
          {/* Qatar marker */}
          <div 
            className={`absolute left-[10%] top-1/2 -translate-y-1/2 transition-all duration-700 ${
          ...
          {/* Heart in middle */}
          <div 
            className={`absolute left-1/2 top-1/4 -translate-x-1/2 transition-all duration-1000 delay-500 ${
          ...
          {/* Kenya marker */}
          <div 
            className={`absolute right-[10%] top-1/2 -translate-y-1/2 transition-all duration-700 delay-300 ${
              isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'
            }`}
          >
            <div className="relative">
          ...
          {/* Animated plane */}
          <div 
            className={`absolute top-[15%] transition-all duration-2000 ${
        ...
        <div className="text-center">
          ...
          <p className="font-display text-xl text-foreground">
            February is closer than it seems.
          </p>
        </div>
      </div>
    </section>
