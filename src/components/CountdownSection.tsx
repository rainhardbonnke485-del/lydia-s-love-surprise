...
const CountdownSection = () => {
  ...
  useEffect(() => {
    const targetDate = new Date('2025-03-17T00:00:00'); // March 17th meetup
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold text-foreground mb-4">
            Counting Days Until <span className="text-secondary">March</span>
          </h2>
        ...
        <div className="text-center">
          ...
          <p className="font-script text-2xl text-secondary">
            Counting down the seconds until March 17th... 🛫❤️
          </p>
        </div>
      </div>
    </section>
