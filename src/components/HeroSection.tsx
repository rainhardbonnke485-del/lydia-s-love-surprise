  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 text-center px-4 max-w-4xl mx-auto">
        ...
        {/* Main title */}
        <h1 className="font-display text-4xl sm:text-5xl md:text-7xl font-bold text-glow animate-pulse-glow mb-6">
          ...
          <Heart className="inline-block w-8 h-8 md:w-12 md:h-12 text-primary fill-primary ml-2 animate-float" />
        </h1>
        ...
        <div className="relative w-48 h-48 sm:w-64 sm:h-64 mx-auto mb-10 rounded-full overflow-hidden shadow-glow animate-glow-pulse">
          ...
          <div className="absolute inset-2 rounded-full border-2 border-gold/50 flex items-center justify-center bg-card">
            <div className="text-center">
              <Heart className="w-12 h-12 text-primary mx-auto mb-2" />
              <span className="text-sm text-muted-foreground font-display">Lydia's Photo</span>
            </div>
          </div>
        </div>
